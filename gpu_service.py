...
gpu_app = FastAPI()
max_cache_action = 8
with open("/home/geyuan/local_soft/TCL/collected_data_0514_shovel_source/statistics.json", 'r') as json_file:
...
def get_agent(device: str):
    ...
    # 1. Load hydra config
    train_dir = "/home/geyuan/code/dp23rss_fork/data/outputs/2025.05.14/22.47.01_train_diffusion_transformer_hybrid_pusht_images"
