...
export TRAIN_DIR=/home/geyuan/code/dp23rss_fork/data/outputs/2026.04.16/01.19.48_train_diffusion_transformer_hybrid_robosuite_state
...
def model_step(step_request: StepRequestFromEvaluator):
    device = os.getenv("DEVICE", "cuda")
    use_ema = _str2bool(os.getenv("USE_EMA"), True)
    agent, _, _, state_dim, action_dim, n_obs_steps = get_agent(device=device, use_ema=use_ema)
